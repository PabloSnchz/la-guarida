 ...
 * v6 — Twitch + YouTube mejorados + iconos oficiales
 */
(function (root) {
  'use strict';
  ...
  function widgetTitleHTML(iconUrl, label) {
    return '<div class="widget-title"><img src="' + iconUrl + '" alt="" width="20" height="20" style="vertical-align:middle;margin-right:6px;border-radius:4px;">' + label + '</div>';
  }
  ...
  function renderWidget(widget) {
    switch (widget.type) {
      ...
      case 'greeting': return '<div class="widget widget--greeting">' + widgetTitleHTML(WIDGET_ICONS.greeting, 'Saludo') + '<div class="widget-greeting-text">' + (new Date().getHours() < 12 ? 'Buenos días' : new Date().getHours() < 20 ? 'Buenas tardes' : 'Buenas noches') + '</div></div>';
